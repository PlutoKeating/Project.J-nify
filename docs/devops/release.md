...
- 历史已发布 versionCode：`v0.1.0=1`、`v0.1.1=2`、`v0.1.2=3`、`v0.1.3=1`、`v0.1.4=1`、`v0.1.5=4`、`v0.2.0=5`、`v0.3.0=6`。⚠️ v0.1.3/v0.1.4 曾误用 `+1` 导致覆盖安装被拒（背景见上）；当前最大 versionCode=6，**新版本必须 > `+6`**。
