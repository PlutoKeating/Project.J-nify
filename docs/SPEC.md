...
M1 信号	—	屏幕使用/系统日历/天气/位置（本地处理）+ 本地通知执行层 + 节奏表	✅ 2026-08-29 随 v0.2.0 发布；提醒有真实理由，执行层本地闭环生效
M2 Jennifer 大脑	—	LLM 解析、拆解、话术、兜底草稿；文档集/记忆/流式/撤销/成本看板	✅ 2026-08-29 随 v0.3.0 发布；模型失败自动切换，无可用 LLM 时诚实报错
